...
init(_Args) -> 
	...
	io:format("I:ch_sup init!~n"),
	{ok, {{one_for_one, 100, 60}, [
								   {ch3, {ch3, start_link, []}, permanent,80000, worker, [ch3]},
								   {gen_event_test1, {gen_event_test1, start_link, []}, permanent,80000, worker, [gen_event_test1]}
								  ]}}.
